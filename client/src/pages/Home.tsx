...
export default function HomePage() {
  ...
  useEffect(() => {
    const handleGlobalDragOver = (e: DragEvent) => {
      e.preventDefault();
      if (!isDiscoveryMode && currentRoom?.isMember && currentChannel && e.dataTransfer?.types.includes('Files')) {
        setIsDragging(true);
      }
    };
    ...
    const handleGlobalDrop = (e: DragEvent) => {
      ...
      if (isDiscoveryMode || !currentRoom?.isMember || !currentChannel) return;
  ...
  }, [isDiscoveryMode, currentRoom, currentChannel, addToast]);
